...
/* ========================================================
   TOGGLE LABEL WILAYAH DI LAYER CONTROL
   ======================================================== */

(function initLabelWilayahControl() {

    function pasangToggleLabel() {
         ...
         * sebelum Batas Kabupaten
         */
        layerControl.prepend(wrapper);
    ...
    /*
     * Layer control bisa dibuat setelah
     * script map selesai.
     *
     * Karena itu kita cek sebentar sampai
     * kontrol Leaflet tersedia.
     */
    let percobaan = 0;
